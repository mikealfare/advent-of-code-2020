from tests.conftest import day_4, PACKAGE_ROOT
...
def test_get_passport_from_config_string_full():
    passport = day_4.get_passport_from_config_string(config_string=sample_passport_string_full)
...
def test_get_passport_from_config_string_missing_height():
    passport = day_4.get_passport_from_config_string(config_string=sample_passport_string_missing_height)
...
def test_get_passports_from_file():
    sample_file = PACKAGE_ROOT / 'static' / 'day_4.txt'
    passports = day_4.get_passports_from_file(sample_file.absolute())
